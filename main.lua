...
initUi = function()
    ...
    hud.Quests.Daily.onRelease = function(self)
        _QUEST_TAB = "Daily"
        updateUi()
    end
...
updateUi = function()
    ...
    if _CURRENT_SCREEN == "Quests" then
        ...
        hud.Quests.Career.Width, hud.Quests.Career.Height = Screen.Width / 4, Screen.Height / 15
